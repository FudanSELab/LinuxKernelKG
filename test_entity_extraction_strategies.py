...
class EntityExtractionEvaluator:
    ...
    def __init__(self, benchmark_file=None):
        ...
        self.llm1 = deepseek()  # 主模型
        self.llm2 = deepseek()  # 辅助模型 (可以是同一个模型实例)
    ...
    def _get_test_cases(self):
        ...
        test_cases = {
            ...
            "test2": {
                ...
                'version': 'v5.15',
                'mentions': ['TCP', 'congestion control', 'algorithm', 'high-latency networks']
            },
            "test3": {
                'h1': 'File Systems',
                'h2': 'Ext4',
                ...
                'version': 'v5.15',
                'mentions': ['inode numbers', 'ext4', 'filesystem', 'larger']
            }
        }
        return test_cases
