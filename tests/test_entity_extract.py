...
class TestEntityExtraction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.benchmark_file = "data/mention_extraction_benchmark_0225.xlsx"
    ...
    def test_entity_extraction_accuracy(self):
        ...
        # 创建详细结果文件
        detailed_results_file = 'output/entity_extraction_detailed_results.txt'
    ...
    def _save_results_to_csv(self, results: Dict):
        ...
        feature_df.to_csv('output/entity_extraction_feature_results.csv', index=False)
        ...
        overall_df.to_csv('output/entity_extraction_overall_results.csv', index=False)
        self.logger.info("Results saved to CSV files in output directory")
